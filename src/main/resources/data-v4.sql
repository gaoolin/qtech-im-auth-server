...
-- 插入系统信息
INSERT INTO im_auth_system (sys_name, status, created_by, updated_by, remark)
VALUES ('智能制造系统', '0', 'admin', 'admin', '智能制造系统的认证和授权管理');

-- 插入部门信息
INSERT INTO im_auth_dept (parent_id, ancestors, dept_name, order_num, leader, email, phone, status, created_by, updated_by, remark)
...
-- 插入用户信息
INSERT INTO im_auth_user (emp_id, username, nickname, pw_hash, gender, dept_id, avatar, email, phone, user_type, status, created_by, updated_by, remark)
...
-- 插入角色信息
INSERT INTO im_auth_role (role_name, role_key, role_sort, data_scope, menu_check_strictly, dept_check_strictly, status, created_by, updated_by, remark)
VALUES ('生产管理员', 'ROLE_PROD_ADMIN', 1, '1', '1', '1', '0', 'admin', 'admin', '生产部管理员');
INSERT INTO im_auth_role (role_name, role_key, role_sort, data_scope, menu_check_strictly, dept_check_strictly, status, created_by, updated_by, remark)
VALUES ('研发管理员', 'ROLE_DEV_ADMIN', 2, '1', '1', '1', '0', 'admin', 'admin', '研发部管理员');

-- 插入权限信息
INSERT INTO im_auth_permission (perm_name, sys_id, app_name, rsrc_name, action_type, status, created_by, updated_by, remark)
...
-- 插入OAuth2客户端信息
INSERT INTO im_auth_oauth_client (client_id, client_name, sys_name, client_secret, grant_types, redirect_uris, scopes, status, created_by, updated_by, remark)
...
-- 插入API Key信息
INSERT INTO im_auth_api_key (user_id, api_key, expires_at, created_by, updated_by, remark)
...
-- 插入会话信息
INSERT INTO im_auth_session (user_id, session_token, expires_at, created_by, updated_by, remark)
...
-- 插入审计日志信息
INSERT INTO im_auth_audit_log (user_id, action, ip_address, remark)
